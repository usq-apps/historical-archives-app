                    ...
                    <div x-init="addMediaAnimation($refs.mediaElement)" class="flex items-center justify-center py-6">
                        <div class="flex justify-center size-72">
                            <div id="mediaThumbnail" data-flip-id="media" class="relative flex justify-center [&.active]:hidden [&.flipping]:visible cursor-pointer">
                                <x-icon.magnifying-glass-plus size="8" class="absolute text-gray-300 bottom-0 -right-10" />
                        ...
                        <div id="mediaBackground" class="flex fixed items-center justify-center top-0 left-0 bg-black z-40 invisible">
                            ...
                            <div x-data="{ mediaData: '' }" x-modelable="mediaData" wire:model="mediaData" id="mediaFullSize" data-flip-id="media" class="object-scale-down z-20">
                                <!-- Load Documents -->
                                <template x-if="mediaData.collectionName === 'documents'">
                                ...
                                <!-- Load Images -->
                                <template x-if="mediaData.collectionName === 'images'">
                                    <img :src="mediaData.srcPath">
                                </template>

                                <!-- Load Videos or Audio -->
                                <template x-if="mediaData.collectionName === 'videos' || mediaData.collectionName === 'audio'">
